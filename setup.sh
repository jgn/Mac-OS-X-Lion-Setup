...
##    /usr/bin/defaults write com.apple.TimeMachine 'AutoBackup' -bool false
    ...
    ### Use AirDrop over every interface: https://github.com/holman/dotfiles/blob/master/osx/set-defaults.sh#L14
...
##  /usr/bin/defaults write com.apple.finder 'FXPreferredGroupBy' -string 'Kind'
  ...
  # See https://github.com/holman/dotfiles/blob/master/osx/set-defaults.sh#L17
  /usr/bin/defaults write com.apple.Finder FXPreferredViewStyle Nlsv

  # Set the Finder prefs for showing a few different volumes on the Desktop: https://github.com/holman/dotfiles/blob/master/osx/set-defaults.sh#L25
